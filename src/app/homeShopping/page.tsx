  ...
  const handleChannelChange = (event: any) => {
    ...
    if (id === "channelall") {
      ...
      if (selectedChannelsView.includes("전체")) {
        setSelectedChannelsView(
          selectedChannelsView.filter((i) => i != "전체")
        );
                  ...
                  <li key={idx}>
                    ...
                    <div className="chart">
                      {category.cnt ? (
                        <a
                          href=""
                          onClick={(e) => cateOpen(e, category.kind)}
                          key={idx}
                        >
                ...
                <li key={idx}>
                  ...
                  <div className="chart">
                    {shopCate.cnt ? (
                      <a
                        href=""
                        onClick={(e) => shopOpen(e, shopCate.kind)}
                        key={idx}
                      >
                  ...
                  >
                    ...
                    <div className="chart">
                      ...
                      {standardCategory.cnt ? (
                        <a
                          href=""
                          onClick={(e) => timeOpen(e, standardCategory.kind)}
                          key={idx}
                        >
                          <div
